...
import ca.uhn.fhir.jpa.starter.ApplicationContext;
...
public class FhirServerConfigCommon {
   ...
   * The 'url' property value of "jdbc:derby:directory:jpaserver_derby_files;create=true" indicates that the server should save resources in a
